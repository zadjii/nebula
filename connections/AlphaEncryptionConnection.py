...
class AlphaEncryptionConnection(AbstractConnection):
    ...
    def recv_obj(self):
        ...
        try:
            ...
            _log.debug('Exception while decoding message. Damn.')
    ...
    def send_obj(self, message_obj):
        ...
        # encrypted_msg = self._box.encrypt(msg_json, None, HexEncoder)
    ...
    def send_next_data(self, data):
        encrypted_msg = self._box.encrypt(data, None, HexEncoder)
        self._conn.send_next_data(encrypted_msg)
